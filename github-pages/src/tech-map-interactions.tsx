...
const details: Record<string, Detail> = {
  ...
  'node-azure': { title: 'Azure IaC', summary: 'I am building Azure infrastructure-as-code knowledge around repeatability and operational clarity.', built: 'I am developing Azure IaC practices alongside my cloud data work, with a focus on reproducible environments and clear delivery patterns.', patterns: ['Infrastructure as code in progress', 'Cloud data platform foundations', 'Environment-aware delivery'], outcome: 'A practical foundation for more consistent cloud data platform delivery.' },
